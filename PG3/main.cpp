...
/// <summary>
///	引数の文字列から番号を抽出し、その比較を行う関数
/// </summary>
/// <param name="a">文字列a</param>
/// <param name="b">文字列b</param>
/// <returns>どちらの数字が大きいか</returns>
int extractAndConvertToNumber(const char* str) {
	// 数字以外の文字を削除
